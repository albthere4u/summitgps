// ================================================================
// 안내도 기반 데이터. px 는 assets/resort-map-v4.png (1672x941) 위 픽셀 좌표.
// 배경 이미지에 라벨·핀이 이미 그려져 있으므로 앱은 작은 링 마커만 겹쳐 그린다.
// ================================================================
window.MAP_IMG = { src:'assets/resort-map-v4.png', w:1672, h:941 };
window.PX_SCALE = 1;
...
window.CALIB = [
  ...
  // 9/22 현장 보정 (여러 샘플 정확도 가중 평균)
  { px:[1467,555], lat:20.913544,  lng:-156.693275,  name:'Napili 엘리베이터 (현장)' },
  { px:[964,657],  lat:20.913013,  lng:-156.692206,  name:'Atrium 엘리베이터 (현장)' },
  { px:[1538,768], lat:20.913895,  lng:-156.692945,  name:'흡연 구역 (현장)' },
];
...
window.SCHEDULE = [
  { date: '2026-09-22', day: 'Day 1 · 화', items: [
    ...
    { s: '17:00', e: '21:00', t: '석식', v: null, place: 'Olowalu Plantation House (리조트 밖)', gmaps: 'Olowalu Plantation House, Olowalu, HI', mode: 'driving' },
  ]},
  { date: '2026-09-23', day: 'Day 2 · 수', items: [
    ...
    { s: '16:30', e: '20:30', t: '석식', v: null, place: "Leilani's on the Beach, Whalers Village (리조트 밖)", gmaps: "Leilani's on the Beach, Whalers Village, Kaanapali, HI", mode: 'walking' },
  ]},
  { date: '2026-09-24', day: 'Day 3 · 목', items: [
    ...
    { s: '16:30', e: '21:00', t: '루아우 (Luau)', v: null, place: 'Westin Maui – Aloha Pavilion (리조트 밖)', gmaps: 'The Westin Maui Resort & Spa, Ka\'anapali, HI', mode: 'walking' },
  ]},
];
